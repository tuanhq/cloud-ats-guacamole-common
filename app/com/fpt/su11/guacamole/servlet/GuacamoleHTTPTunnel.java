 ...
 */
public abstract class GuacamoleHTTPTunnel extends Controller {

    /**
     * Logger for this class.
     */
    private Logger logger = LoggerFactory.getLogger(GuacamoleHTTPTunnel.class);
...
//    protected void handleTunnelRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException {
      protected void handleTunnelRequest() throws Exception {
     ...
     */
    protected abstract GuacamoleTunnel doConnect() throws GuacamoleException;
...
//    protected void doRead(HttpServletRequest request, HttpServletResponse response, String tunnelUUID) throws GuacamoleException {
    protected void doRead(String uuidKey, String tunnelUUID) throws GuacamoleException {
...
//                out.close();
     ...
     *                            request.
     */
    protected void doWrite(String uuidKey, String tunnelUUID) throws GuacamoleException {
